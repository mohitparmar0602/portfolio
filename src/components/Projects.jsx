...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col ${isEven ? "lg:flex-row" : "lg:flex-row-reverse"} gap-16 lg:gap-24 items-center mb-16 md:mb-24 group`}
    >
      ...
      <div className="lg:w-1/2 relative">
        ...
        <div className={`absolute -top-16 ${isEven ? "-left-10" : "-right-10"} text-[10rem] font-serif leading-none text-behance-dark/[0.03] pointer-events-none select-none z-0`}>
           0{index + 1}
        </div>
      </div>
      ...
      <div className="lg:w-1/2 space-y-10 z-10">
        <div className="space-y-6">
          ...
          <h3 className="text-3xl md:text-5xl font-serif text-behance-dark tracking-tight leading-[0.9]">
            {project.title}
          </h3>
  ...
  return (
    <section id="projects" className="py-24 md:py-32 bg-behance-cream relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-[0.02] flex items-center justify-center -z-0">
         <span className="text-[30vw] font-serif font-outline tracking-tighter">WORKS</span>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-serif text-behance-dark mb-8 leading-[0.85] tracking-tight">Featured <br /> Projects</h2>
        ...
        <div className="space-y-0">
          {PROJECTS.map((project, index) => (
            <React.Fragment key={project.title}>
              {index === 2 && <div className="h-20 md:h-32" />}
