...
const ContactButton = ({ href, label, icon, color = "bg-behance-coral", isBrand = false }) => (
  ...
  >
    ...
    <a 
      ...
      className={`block w-full ${color} text-white py-4 md:py-5 pl-14 pr-6 rounded-full text-[9px] md:text-xs font-accent font-bold tracking-[0.2em] shadow-xl transition-all uppercase text-ellipsis overflow-hidden whitespace-nowrap hover:bg-behance-dark`}
    >
      {label}
    </a>
  </motion.div>
...
const Contact = () => {
    ...
    return (
        <section id="contact" className="py-24 md:py-32 bg-behance-cream relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-0 w-full text-center text-[20vw] font-serif text-behance-dark/[0.02] pointer-events-none select-none -z-0">
                TOUCH
            </div>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        <div className="space-y-6 text-center lg:text-left">
                            <span className="text-behance-coral font-accent font-bold tracking-[0.5em] uppercase text-[9px] block">Collaborate</span>
                            <h2 className="text-5xl md:text-8xl font-serif text-behance-dark leading-[0.8] tracking-tighter">
                                Let's <br /> Connect
                            </h2>
                        </div>
